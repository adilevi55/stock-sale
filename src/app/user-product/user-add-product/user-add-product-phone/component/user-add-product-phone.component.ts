...
@Component({
  ...
  templateUrl: './user-add-product-phone.component.html',
  styleUrls: ['./user-add-product-phone.component.css']
})
export class UserAddProductPhoneComponent implements OnInit, OnDestroy {
